...
- ***[Download Guide](./installing-guides/getting-started/install-guides/download-guide)*** (*Recommended*): 
Our downloadable version, install it and run Joget DX on your computer.
