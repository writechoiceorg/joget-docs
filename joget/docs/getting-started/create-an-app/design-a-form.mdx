...
We will create a form to continue the development of our Traves Request app. You will use forms to acquire data and store it on the server. Follow the steps on this page to create your first form.
